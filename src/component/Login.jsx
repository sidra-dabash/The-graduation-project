    ...
    <>
      <div className="flex justify-center items-center min-h-screen bg-pink-50">
        ...
        >
          ...
          <label
            htmlFor="password"
            className="text-pink-500 text-sm sm:text-base"
          >
            Password
          </label>
          <input
            ...
            className="border border-gray-300 rounded-[10px] p-3 focus:ring-2 focus:ring-pink-500 focus:outline-none"
          />
          <label htmlFor="re-password" className="text-pink-500 ">
            Re-Password
          </label>
          <input
            type="password"
            ...
            className="border border-gray-300 rounded-[10px] p-3 focus:ring-2 focus:ring-pink-500 focus:outline-none"
          />
          <button class="px-6 py-3 bg-gradient-to-r from-pink-500 to-sky-300 text-white font-bold text-lg rounded-full shadow-lg hover:shadow-xl transform hover:sc transition-all duration-300">
            Login
          </button>
        </form>
      </div>
